    ...
    <div id="myCarousel" className="carousel slide" data-ride="carousel">
      ...
      <div className="carousel-inner">
        ...
        <div className='col-sm-4' style={{borderRadius:5, fontSize:20}}>
          <h3 className='text-center' style={{color:'#2980b9'}}>Mission</h3>
          ...
          <h3 className='text-center' style={{color:'#2980b9'}}>Vision</h3>
          ...
          <h3 className='text-center' style={{color:'#2980b9'}}>Brief of NABTEB</h3>
        ...
        <div className='col-sm-4' style={{fontSize:20}}>
          <h3 className='text-center' style={{color:'#2980b9'}}>Quick Links</h3>
        ...
        <div className='col-sm-4' style={{fontSize:20, marginTop:-5}}>
          <h3 className='text-center' style={{color:'#2980b9'}}>News & Events</h3>
          <div style={{marginTop:-10}}>
            ...
            <div className='row' style={{borderBottomStyle:'solid', borderWidth:'1px', margin:5}}>
             ...
             <button className='btn btn-primary '> Read More News &raquo;</button>
          </div>
