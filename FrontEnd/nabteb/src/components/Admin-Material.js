          ...
          <Paper zDepth={1}>
            <div className='panel panel-default'>
              <div className='panel-heading'>
                <div className='text-info text-center' style={{fontSize:25, color:'#34495e'}}>ENGINEERING TRADES (NTC)</div>
              </div>
                ...
                <ul>
                  <table class="table table-striped">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td>2.</td>
                        <td>Motor Vehicle Mechanics Works</td>
                        <td>
                          <Link to='#'>
                          <RaisedButton
                            labelStyle={{color:'white'}}
                      ...
                      <tr>
                        <td>3.</td>
                        <td>Automobile Electrical Works</td>
                        <td>
                          <Link to='#'>
                          <RaisedButton
                            labelStyle={{color:'white'}}
