...
export default class AdminCandidateRegistration extends Component {
  constructor (props) {
    super(props)
    this.state = {
      fees:[],
  ...
  componentWillMount () {
    var tempFees=[]
    fetch("http://localhost:8080/registration/fees").then(response =>response.json()).then(fees => {
      fees.forEach((fee)=> {
        ...
        <table class="table table-striped"  style={{fontFamily:"Times New Roman", fontSize:18}}>
          <thead>
            <tr>
              ...
              <th>Phone Number</th>
              <th>Remita Retrieval Reference No.</th>
              <th>Date</th>
              <th>Amount</th>
            </tr>
          </thead>
            ...
            <div className='panel panel-default'>
              ...
              <div className='panel-body'>
                 <Tabs>
                        ...
                        <Tab label="Registration Payments" style={{backgroundColor:'#16a085', fontSize:18}}>
                          <div className='panel-body'>
