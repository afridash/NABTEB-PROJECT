...
export default class AdminScholars extends Component {
  constructor (props) {
    super(props)
    this.state = {}
  }
  ...
  showPageContent(){
      return (
        <div className="col-sm-10 col-sm-offset-1">
          <h3 className='text-info text-center'>Scholars</h3>
          <Paper zDepth={1}>
            <div className='panel panel-default'>
              <div className='panel-heading'>
                <div className='text-info text-center'>
                  {/*Search for all fields (last, first, location etc...)*/}
                          ...
                          <ol style={{fontSize:20, fontFamily:'Times New Roman'}}>
                            <table class="table table-striped">
                              ...
                              <tbody>
                                <tr>
                                  <td>1</td>
                                  <td ><Link to='/user/admin/scholarinfo' style={{color:'black'}}>John Doe</Link></td>
                                  <td>Plot 20, Garki estate, Garki, Abuja</td>
                                  <td>Scholar</td>
                                </tr>
                                <tr>
                                  <td>2</td>
                                  <td><Link to='/user/admin/scholarinfo' style={{color:'black'}}>Ibrahim Suleiman</Link></td>
                                  <td>Plot 100,road 2, block 40 Wuse II, Abuja</td>
                                  <td>Scholar</td>
                                </tr>
                                <tr>
                                  <td>3</td>
                                  <td><Link to='/user/admin/scholarinfo' style={{color:'black'}}> Susan Musa </Link></td>
                                  <td>Plot 100,road 2, block 40 Wuse II, Abuja</td>
                                  <td>Scholar</td>
                                </tr>
                              </tbody>
